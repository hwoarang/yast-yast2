  ...
  class FirewallClass < Module
    ...
    def self.create(backend_sym = nil)
      ...
      # to detect which backend is enabled and create the appropriate instance.
        ...
        running_backends = get_running_backends
  ...
  class SuSEFirewalldClass < FirewallClass
    ...
    def SetAllowedServicesForZoneProto(allowed_services, zone, protocol)
      ...
      if !services.empty?
        ...
        services.each do |s|
          add_to_zone_attr(zone, :services, s) if !in_zone_attr?(zone, :services, s)
        end
        add_zone_modified(zone, :services)
      end
    ...
    private
      ...
      def set_zone_modified(zone, zone_params)
        ...
        return nil if zone_params.nil? or \
          !@known_firewall_zones.include?(zone) or \
      ...
      def add_zone_modified(zone, zone_param)
        # Do nothing if the parameters are not valid
        return nil if zone_param.nil? or \
